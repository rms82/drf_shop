...
class Post(TimeModel):
    author = models.ForeignKey(ProfileUser, on_delete=models.CASCADE, related_name='posts')
...
class Comment(TimeModel):
    ...
    user = models.ForeignKey(ProfileUser, on_delete=models.CASCADE, related_name='comments')
